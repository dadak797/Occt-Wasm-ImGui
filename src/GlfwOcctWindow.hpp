...
#ifndef _GlfwOcctWindow_HeaderFile
#define _GlfwOcctWindow_HeaderFile
...
//!
//! By default, GlfwOcctWindow::DoResize() will scale backing store of a canvas basing on DevicePixelRatio() scale factor
...
//! Consider changing ToScaleBacking flag passed to GlfwOcctWindow constructor in case of issues.
...
public:
  ...
  Standard_EXPORT GlfwOcctWindow (const TCollection_AsciiString& theCanvasId,
                               const bool theToScaleBacking = true);

  //! Destroys the window.
  Standard_EXPORT virtual ~GlfwOcctWindow();
...
#endif // _GlfwOcctWindow_HeaderFile
