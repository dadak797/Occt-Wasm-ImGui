...
// purpose  :
// =======================================================================
GlfwOcctWindow::GlfwOcctWindow (const TCollection_AsciiString& theCanvasId,
  ...
  m_Window(NULL)
{
  ...
  if (myToScaleBacking)
  {
    ...
    m_Window = glfwCreateWindow(mySize.x(), mySize.y(), theCanvasId.ToCString(), nullptr, nullptr);
    if (!m_Window)
    {
...
// purpose  :
// =======================================================================
void GlfwOcctWindow::Position (Standard_Integer& theX1, Standard_Integer& theY1,
...
// purpose  :
// =======================================================================
void GlfwOcctWindow::Size (Standard_Integer& theWidth,
...
// purpose  :
// =======================================================================
void GlfwOcctWindow::SetSizeLogical (const Graphic3d_Vec2d& theSize)
{
...
// purpose  :
// =======================================================================
void GlfwOcctWindow::SetSizeBacking (const Graphic3d_Vec2i& theSize)
{
  mySize = theSize;
  if (IsVirtual())
  {
...
// purpose  :
// =======================================================================
void GlfwOcctWindow::InvalidateContent (const Handle(Aspect_DisplayConnection)& )
{
  //
}
...
// purpose  :
// =======================================================================
bool GlfwOcctWindow::ProcessMessage (Aspect_WindowInputListener& theListener,
...
// purpose  :
// =======================================================================
bool GlfwOcctWindow::ProcessMouseEvent (Aspect_WindowInputListener& theListener,
                                     int theEventType, const EmscriptenMouseEvent* theEvent)
{
  ...
  const Aspect_VKeyMouse aButtons = GlfwOcctWindow::MouseButtonsFromNative (theEvent->buttons);
  switch (theEventType)
  {
    case EMSCRIPTEN_EVENT_MOUSEMOVE:
    {
...
// purpose  :
// =======================================================================
bool GlfwOcctWindow::ProcessWheelEvent (Aspect_WindowInputListener& theListener,
...
// purpose  :
// =======================================================================
bool GlfwOcctWindow::ProcessTouchEvent (Aspect_WindowInputListener& theListener,
...
// purpose  :
// =======================================================================
bool GlfwOcctWindow::ProcessKeyEvent (Aspect_WindowInputListener& theListener,
                                   int theEventType, const EmscriptenKeyboardEvent* theEvent)
{
  ...
  const Aspect_VKey aVKey = GlfwOcctWindow::VirtualKeyFromNative (theEvent->keyCode);
...
// purpose  :
// =======================================================================
bool GlfwOcctWindow::ProcessUiEvent (Aspect_WindowInputListener& theListener,
...
// purpose  :
// =======================================================================
bool GlfwOcctWindow::ProcessFocusEvent (Aspect_WindowInputListener& theListener,
...
// purpose  :
// =======================================================================
Aspect_VKeyMouse GlfwOcctWindow::MouseButtonsFromNative (unsigned short theButtons)
{
...
// purpose  :
// =======================================================================
Aspect_VKey GlfwOcctWindow::VirtualKeyFromNative (Standard_Integer theKey)
{
#if defined(__EMSCRIPTEN__)
  if (theKey >= DOM_VK_0
   && theKey <= DOM_VK_9)
